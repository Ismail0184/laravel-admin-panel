                        ...
                        <div class="p-2">
                            ...
                            <form method="POST" action="{{ route('password.email') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" required autofocus placeholder="Enter email">
                                </div>
...
<!-- Mirrored from themesbrand.com/skote/layouts/vertical/auth-recoverpw.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 08 Sep 2020 15:08:04 GMT -->
</html>
